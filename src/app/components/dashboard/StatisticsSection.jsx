    ...
    <section className="space-y-6" aria-labelledby="statistics-heading">
      ...
      {showCharts ? (
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <StatisticsCard title="Successful Transaction Volumes" to="/dashboard/statistics/successful-transactions">
          ...
          <StatisticsCard title="Success vs Failed" to="/dashboard/statistics/successful-transactions">
            <ResponsiveContainer width="100%" height={140}>
              <PieChart>
                <Pie
          ...
          <StatisticsCard title="Failed Transactions (Top 5 Codes)" to="/dashboard/statistics/failed-codes">
            <ResponsiveContainer width="100%" height={140}>
              <BarChart data={failedTop5Codes.slice(0, 3)} layout="vertical" margin={{ top: 5, right: 5, left: 60, bottom: 0 }}>
                ...
                <Tooltip />
                <Bar dataKey="count" fill={chartColors[3]} radius={[0, 2, 2, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </StatisticsCard>

          <StatisticsCard title="Transactions by Channel (Bar)" to="/dashboard/statistics/by-channel">
            <ResponsiveContainer width="100%" height={140}>
          ...
          <StatisticsCard title="Channel Mix (Pie)" to="/dashboard/statistics/by-channel">
            <ResponsiveContainer width="100%" height={140}>
              <PieChart>
                <Pie
                  data={channelPie}
