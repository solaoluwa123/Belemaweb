...
export const belemaBrand = {
  ...
  theme: {
    ...
    /** Primary actions match `balema_logo.png` continent green. */
    primary: "#548235",
    primaryForeground: "#ffffff",
    primaryHover: "#456c2b",
    secondary: "#eef6e6",
    secondaryForeground: "#2f3d2a",
    muted: "#f5f8f2",
    mutedForeground: "#334155",
    accent: "#e2f0d4",
    accentForeground: "#2f3d2a",
    destructive: "#d4183d",
    destructiveForeground: "#ffffff",
    border: "#d5e2c8",
    inputBackground: "#f7f9f4",
    switchBackground: "#c5d9b0",
    ring: "#548235",
    chart: ["#548235", "#7a9e60", "#f0a63a", "#d65252", "#a8c48a"],
    sidebar: "#f2f5ef",
